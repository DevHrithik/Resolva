  ...
  return (
    <div className="min-h-screen w-full ">
      <div className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center mb-8 bg-[#020617] p-4 rounded-xl border border-[#2A2A2A]">
        ...
        <div className="bg-[#111111] rounded-2xl border border-[#2A2A2A] overflow-hidden">
          {/* Dashboard Header */}
          <div className="p-6 border-b border-[#2A2A2A] bg-[#020617]">
          ...
          <div className="px-6 py-4 bg-[#020617] border-t border-[#2A2A2A]">
